  ...
  users.users = {
    ...
    root = {
      ...
      openssh.authorizedKeys.keys = [
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEd7udiygWP2fPGs+8W8Pkj5vX83Civ8TrmrTRhSyAuQ panos@panix.eu"
        "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBFmhiSGRQ/AvB43ZCKa+HC6kwfs9xzZZc2DDrDnpzCMn7NflhAqVGBzso5EZvmBS+XywdSGXjMNvLBcgvHC5qoY= panagiotis.lampropoulosibm.com@panoss-mbp.ams.nl.ibm.com"
      ];
    };
